...
(function ($) {
  var Notification = function (element, options) {
    ...
    if(this.options.key) {
      this.$note = $("#alert-notify-" + this.options.key);
      if(this.$note.length == 0) this.$note = null;
      else this.$note.attr('class','alert');
    } 
    ...
    this.$note.attr('id','alert-notify-' + this.options.key);
