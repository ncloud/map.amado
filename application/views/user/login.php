    ...
    <script type="text/javascript">
        ...
        function toggle_login_mode()
        {
            ...
            if($form.hasClass('login_mode')) {
                ...
                $button.removeClass('login-button').removeClass('btn-primary').addClass('btn-info').addClass('join-button').html('회원 가입');
                $toggle_button.removeClass('join-button').removeClass('btn-info').addClass('btn-primary').addClass('login-button').html('로그인');
                ...
                $button.removeClass('join-button').removeClass('btn-info').addClass('btn-primary').addClass('login-button').html('로그인');
                $toggle_button.removeClass('login-button').removeClass('btn-primary').addClass('btn-info').addClass('join-button').html('회원가입');
