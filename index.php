 ...
 * reasons you are encouraged to change this to 0 when your map goes live.
 ...
 */
	...
	if (realpath($share_path) !== FALSE)
	{
		$share_path = realpath($share_path).'/';
	}
 ...
 */
	...
	define('SHAREPATH', str_replace("\\", "/", $share_path));
